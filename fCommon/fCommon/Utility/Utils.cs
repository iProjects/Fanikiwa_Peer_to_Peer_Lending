...
namespace fCommon.Utility
{
    ...
    {
        public static string ENCRIPTION_DECRYPTION_KEY = "fanikiwa_peer_to_peer_lending";
        public static string APP_NAME = "Fanikiwa Peer To Peer Lending";
        public static string APP_NAME_SB = "Fanikiwa";
        ...
        public static int SPLASH_SCREEN_LOAD_TIME = 5;
