...
fanikiwa.offerendpoint.createoffer.init = function(apiRoot) {
	...
	var callback = function() {
		if (--apisToLoad == 0) {
			fanikiwa.offerendpoint.createoffer.populateTerms();
			fanikiwa.offerendpoint.createoffer.populateOfferTypes();
...
fanikiwa.offerendpoint.createoffer.populateTerms = function() {
	var termarray = [ {
		id : "0",
		description : "0"
	}, {
...
fanikiwa.offerendpoint.createoffer.populateOfferTypes = function() {
	var OfferTypearray = [ {
		id : "L",
		description : "Lend"
	}, {
