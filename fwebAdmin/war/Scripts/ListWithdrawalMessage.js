...
function buildTable(response) {
	...
	PopulateWithdrawalMessageTable(response);

	$("#listwithdrawalmessageResult").html(withdrawalmessageTable);

	$('#listWithdrawalMessageTable').DataTable(
			{
...
function PopulateWithdrawalMessageTable(resp) {
	...
	if (!resp.code) {
		...
		withdrawalmessageTable += '<table id="listWithdrawalMessageTable">';
